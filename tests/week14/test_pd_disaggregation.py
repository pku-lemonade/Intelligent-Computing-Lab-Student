...
def test_w14_t01_pd_state_allows_only_monotonic_pipeline_transitions():
    state = _state([1, 2, 3])
...
def test_w14_t02_kv_transfer_uses_real_model_shape():
    state = _state([1, 2, 3])
...
def test_w14_t03_router_respects_compute_and_link_dependencies():
